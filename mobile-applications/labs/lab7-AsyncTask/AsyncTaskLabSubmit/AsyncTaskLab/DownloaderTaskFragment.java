...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Integer> list = bundle.getIntegerArrayList("friends");
	...
	public class DownloaderTask extends AsyncTask<ArrayList<Integer>, Void, String[]> {
        ...
        @Override
        protected String[] doInBackground(ArrayList<Integer>... data) {
            ArrayList<Integer> list = data[0];
            Integer[] resourceIDS = new Integer[list.size()];
            for (int i = 0; i < list.size(); i++) {
                resourceIDS[i] = list.get(i);
            }
